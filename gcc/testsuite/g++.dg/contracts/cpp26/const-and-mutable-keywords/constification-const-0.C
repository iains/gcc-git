...
// { dg-additional-options "-fcontracts -fcontracts-const-keyword" }
...
int main()
{
  ...
  contract_assert mutable(i == 4 ? i : i ); // { dg-error {'mutable' contract modifier requires '-fcontracts-mutable-keyword'} }
