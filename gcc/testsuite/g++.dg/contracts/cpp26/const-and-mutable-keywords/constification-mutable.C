...
// { dg-additional-options "-fcontracts -fcontracts-mutable-keyword" }
...
int main()
{
  ...
  contract_assert const(i == 4 ? i : i ); // { dg-error {'const' contract modifier requires '-fcontracts-const-keyword'} }
